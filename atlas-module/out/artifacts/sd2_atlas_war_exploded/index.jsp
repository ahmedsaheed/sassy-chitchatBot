...
<!-- about -->
<div class="about">
  <a class="bg_links social portfolio" href="https://github.com/ahmedsaheed" target="_blank">
    <span class="icon"></span>
  </a>
  <a class="bg_links social dribbble" href="https://github.com/MMPodesta" target="_blank">
    <span class="icon"></span>
  </a>
  <a class="bg_links social linkedin" href="https://www.google.com/" target="_blank">
    <span class="icon"></span>
  </a>
...
<nav>
  <div class="menu">
    <p class="website_name">ATLAS</p>
    <div class="menu_links">
      <a href="" class="link">AHMED</a>
      <a href="" class="link">MAURICIO</a>
      <a href="" class="link">ANIBE</a>
    </div>
    <div class="menu_icon">
      <span class="icon"></span>
    </div>
...
<section class="wrapper">
  ...
  <div class="container">
    ...
    <div id="scene" class="scene" data-hover-only="false">
      ...
      <p class="p404" data-depth="0.50">ATLAS</p>
      <p class="p404" data-depth="0.10">ATLAS</p>

    </div>

    <div class="text">
      <article>
        <p>I'm alone on the internet, <br>If you dare let's talk!</p>
        <a href = "index2.jsp"><button>i dare!</button></a>
